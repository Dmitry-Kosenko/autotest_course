...
class PublicTransport:
    """Общий класс для общественного транспорта. Содержит основную информацию"""
...
class Bus(PublicTransport):
    """Автобус. Подкласс публичного транспорта.
    Дополнительно содержит кол-во пассажиров, парк приписки и стоимость проезда"""
    ...
    @property
    def park(self):
        """Свойство возвращает парк приписки автобуса"""

        return self.__park

    @park.setter
    def park(self, number: int):
        """Устанавливает парк приписки автобуса если он в диапазоне от 1000 до 9999"""
...
class Tram(PublicTransport):
    """Трамвай. Подкласс публичного транспорта.
    Дополнительно содержит маршрут, его длину и стоимость проезда"""

    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int,
                 route: int, path: int, fare: int):
        super().__init__(brand, engine_power, year, color, max_speed)
        self.__route = route
        self.path = path
        self._fare = fare
    ...
    @property
    def how_long(self):
        """Возвращает время прохождения маршрута"""
