...
def everything_for_your_cat(cats_data: list[tuple[str, int, str, str]]) -> str:
    """
    Оптимизация хранения данных о котиках, путем сокращения дублирующихся записей о покупателях
    :param cats_data: Список кортежей с информацией об отдельном котике
    :type cats_data: list[tuple[str, int, str, str]]
    :return: "многострочная" строка вида: Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    :rtype: str
    """
    ...
    for cat in cats_data:
        owner = f'{cat[2]} {cat[3]}'
        owners[owner] = owners.get(owner, '') + f'{cat[0]}, {cat[1]}; '
