...
def repeats(our_str: str) -> str:
    """
    Подсчет количества повторов символов в строке до текущего символа
    :param our_str: строка для подсчета символов
    :type our_str: str
    :return: строка с добавлением к каждому символу постфикса "_n", где n - количество повторов данного символа
    :rtype: str
    """
    ...
    for symbol in our_str:
        ...
        new_str += f'{symbol}_{str(count_dict[symbol])}'
    return new_str
